...
const Index3OnePage = () => {
  return (
    <Layout header={2} singleMenu footer={3}>
      {/* Hero Section Start */}
      ...
      {/* Headline Area end */}
      {/* About Us Area start */}
      <section id="about" className="about-area-three pt-120 rpt-80 rel z-1">
      ...
      <section
        id="services"
        className="what-we-provide-area pt-130 rpt-100 rel z-1"
      >
      ...
      <section id="projects" className="project-slider-section pt-100 rpt-70">
        <div className="container">
      ...
      {/* Video Area start */}
      <section id="video" className="video-area pt-100 rpt-70 rel z-1">
        <div className="container-fluid">
      ...
      <section id="pricing" className="pricing-area-three pt-80 rpt-50">
        <div className="container container-1290">
          <div className="row justify-content-center">
            <div className="col-xl-8 col-lg-10">
      ...
      {/* Blog Area start */}
      <section id="news" className="blog-area-two pt-130 rpt-100">
        <div className="container">
