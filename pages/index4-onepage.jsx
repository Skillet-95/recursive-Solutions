...
const Index4OnePage = () => {
  ...
  return (
    <Layout header={2} singleMenu footer={4}>
      {/* Hero Section Start */}
      <section
        id="home"
        className="hero-area-four pt-250 rpt-120 pb-220 rpb-100 rel z-1"
      >
      ...
      <section
        id="services"
        className="service-section pt-130 rpt-100 pb-100 rpb-70"
      >
        <div className="container container-1290">
          <div className="row">
      ...
      <section id="awards" className="our-awards-area py-130 rpy-100 rel z-1">
        <div className="container container-1290">
      ...
      <section
        id="news"
        className="blog-area-four pt-130 rpt-100 pb-100 rpb-70"
      >
        <div className="container container-1290">
          <div className="row justify-content-center">
            <div className="col-xl-8 col-lg-10">
        ...
        <div className="container container-1290">
          <div className="row align-items-center justify-content-center justify-content-lg-between">
            ...
            <div className="col-xl-5 col-lg-6 col-md-8 col-sm-10">
              <div className="drop-me-image-part wow fadeInRight delay-0-2s">
